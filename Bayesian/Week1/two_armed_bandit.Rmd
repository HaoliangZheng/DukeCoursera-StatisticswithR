...
* <font color ="red">Posterior - $P(M_1 \text{ is Good} ~|~ \text{Win on } M_1)$ <br/> Prior - $P(M_1 \text{ is Good})$ <br/> Likelihood - $P(\text{Win on } M_1 ~|~ M_1 \text{ is Good})$</font>
...
* <font color="red">$P(M_1\text{ is good}~|~\text{data}) = 0.571$, <br/> $P(M_2\text{ is good}~|~\text{data}) = 0.429$</font>
* $P(M_1\text{ is good}~|~\text{data}) = 0.750$, <br/>$P(M_2\text{ is good}~|~\text{data}) = 0.250$
</div>

```{r Q4}
# Type your code for Question 4 here
data4 <- data.frame(machine = c(1,1,2,2,2),
                    outcome = c("W","W","W","W","L"))
...
data4 <- data.frame(machine = c(2,2,2,1,1),
                    outcome = c("W","W","L","W","W"))
bandit_posterior(data4)
```
...
data41 <- data.frame(machine = c(1,1), outcome = c("W","W"))
data42 <- data.frame(machine = c(2,2,2), outcome = c("W","W","L"))

bandit_posterior(data41) %>% 
  bandit_posterior(data42, prior = .)
```
...
dataE4 = data.frame(machine = c(1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L), outcome = c("L", "W", "L", "W", "L", "L", "L", "W", "W", "W"))
bandit_posterior(dataE4)
...
dataE5 = data.frame(machine = c(1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L), outcome = c("W", "L", "W", "L", "W", "L", "W", "L", "L", "W", "L", "W", "L", "W", "W", "L", "L", "L", "W", "W", "L", "L", "W", "W", "L", "W", "L", "W", "L", "L", "W", "W", "L", "L", "L", "L", "L", "W", "W", "W", "L", "L", "L", "L", "W", "W", "L", "W", "L", "L"))

bandit_posterior(dataE5[1:10,])

bandit_posterior(dataE5[1:10,]) %>%
  bandit_posterior(dataE5[11:20,], prior = .)

bandit_posterior(dataE5[1:10,]) %>%
  bandit_posterior(dataE5[11:20,], prior = .) %>%
    bandit_posterior(dataE5[21:30,], prior = .)

bandit_posterior(dataE5[1:10,]) %>%
  bandit_posterior(dataE5[11:20,], prior = .) %>%
    bandit_posterior(dataE5[21:30,], prior = .) %>%
      bandit_posterior(dataE5[31:40,], prior = .)

bandit_posterior(dataE5[1:10,]) %>%
  bandit_posterior(dataE5[11:20,], prior = .) %>%
    bandit_posterior(dataE5[21:30,], prior = .) %>%
      bandit_posterior(dataE5[31:40,], prior = .) %>%
        bandit_posterior(dataE5[41:50,], prior = .)
```
...
* <font color="red">Both of the above</font>
</div>
