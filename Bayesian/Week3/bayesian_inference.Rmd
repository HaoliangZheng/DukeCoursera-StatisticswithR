...
* <font color="red">Left skewed</font>
* Right skewed
...
* <font color="red">There is a 95% chance that babies on average weigh 7.4 to 7.5 pounds. </font>
</div>
...
* Positive
* Strong
* <font color="red">Very Strong</font>
</div>
...
bayes_inference(y = weight, data = nc_fullterm, 
                ...
                prior_family = "JZS", mu_0 = 7.7, rscale = 1, alternative = "twosided",
                method = "theoretical",
                cred_level = 0.95,
                show_plot=FALSE)
```
...
* <font color="red">there is a 95% chance that their birth weight will be 5.4 to 9.5 pounds.</font>
...
weight_post2 = bayes_inference(y = weight, data = nc_premie, 
                              statistic = "mean", type = "ci",  
                              prior_family = "JZS", mu_0 = 7.7, rscale = 1,
                              method = "simulation",
                              cred_level = 0.95)

samples2 = as.data.frame(weight_post2$samples)
nsim2 = nrow(samples2)
samples2 = mutate(samples2, y_pred = rnorm(nsim2, mu, sqrt(sig2)))

dplyr::select(samples2, mu, y_pred) %>%
  map(quantile, probs=c(0.025, 0.50, 0.975))
```
...
* </font>Both distributions are approximately symmetric.</font>
...
* Get bigger
* Get smaller
* <font color="red">Stay the same</font>
</div>
...
* <font color="red">Get bigger</font>
* Get smaller
* Stay the same
</div>
...
* <font color="red">there is a 95% chance that babies born to nonsmoker mothers are on average 0.11 to 0.54 pounds heavier at birth than babies born to smoker mothers. </font>
</div>
