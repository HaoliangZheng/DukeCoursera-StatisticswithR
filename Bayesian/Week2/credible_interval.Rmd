...
* (0.419, 0.872)
* (0.959, 3.417)
* <font color="red">(5.618, 14.382)</font>
</div>
...
* (-1.678, 5.678)
* (0.043, 0.641)
* <font color="red">(0.063, 0.582)</font>
* (0.071, 0.949)
</div>
...
* (-3.284, 11.284)
* (0.069, 0.693)
* <font color="red">(0.084, 1.372)</font>
* (0.171, 0.969)
</div>
...
* (0.500, 0.536)
* <font color="red">(0.503, 0.531) </font>
* (0.507, 0.530)
* (0.468, 0.496)
</div>
...
* <font color="red">The probability that the true proportion of females lies in this interval is 0.95.</font>
...
* (0.500, 0.528)
* (0.504, 0.532)
* <font color="red">(0.502, 0.527) </font>
</div>
...
* <font color="red">approximately 0.03</font>
* approximately 0.15
* approximately 0.50
* approximately 0.97
</div>
...
* (0.499, 0.535)
* (0.486, 0.509)
* <font color="red">(0.484, 0.511)</font>
</div>
...
* (0.762, 0.785)
* <font color="red">(0.764, 0.783) </font>
* (0.718, 0.737)
* (0.758, 0.789)
</div>
...
* <font color="red">Gamma($a = 22$, $b = 6$) </font>
* Gamma($a = 18$, $b = 5$)
* Gamma($a = 18$, $b = 6$)
* Gamma($a = 19$, $b = 8$)
</div>
...
* Gamma($a = 1$, $b = 5$)
* <font color="red">Gamma($a = 5$, $b = 1$)</font>
* Gamma($a = 100$, $b = 500$)
* Gamma($a = 500$, $b = 100$)
</div>
...
* <font color="red">Gamma($\alpha = 8119$, $\beta = 5001$)</font>
...
* (1.588, 1.659) 
* (1.592, 1.651) 
* <font color="red">(1.594, 1.653) </font>
</div>
