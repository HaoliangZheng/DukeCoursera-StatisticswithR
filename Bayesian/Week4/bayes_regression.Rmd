...
* <font color="red">Observational study</font>
* Experiment
</div>
...
* <font color="red">10 of the respondents make strictly less than 300 dollars per week</font>
...
* <font color="red">For each additional year of education, there is a 95% chance that average weekly wages will increase by $49.04 to $71.39. </font>
</div>
...
* <font color="red">The residuals are strongly left skewed, hence the normal distribution of errors condition is not met.</font>
...
ggpairs(data = wage,columns = c(1,17,2,10))
```
...
* <font color="red">Case 616 has a probably of close to 1 that it an outlier under the normal error model for regressing `lwage` on `iq`</font>
...
* <font color="red">The married black man</font>
...
stepAIC(object = m_lwage_full,k = log(n))
```
...
* `married`, `age`, `black`
* `black`, `south`, `married`
* <font color="red">`meduc`, `urban`, `married`</font>
</div>
```{r Q11}
