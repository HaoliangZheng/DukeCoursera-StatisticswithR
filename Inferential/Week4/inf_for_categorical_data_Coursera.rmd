...
<li><font color="red"> A poll conducted by WIN-Gallup International surveyed 51,927 people from 57 countries. </font></li>
</ol>
...
<li> Telephone </li>
<li> Internet </li> 
<li><font color="red"> All of the above </font></li>
</ol>
...
<ol>
<li> True </li> 
<li><font color="red"> False </font></li>
</ol>
...
<ol>
<li><font color="red"> Countries </font></li> 
...
<ol>
<li> Countries </li> 
<li><font color="red"> Individual Persons </font></li> 
<li> Religions </li>
</ol>
...
table(us12$response)[1]/sum(table(us12$response))
```
...
<li><font color="red"> The margin of error for the estimate of the proportion of atheists in the US in 2012 is 0.0135. </font></li>
</ol>
...
<li><font color="red"> The most conservative estimate when calculating a confidence interval occurs when $p$ is set to 1. </font></li>
</ol>
...
inference(y = response, x = as.factor(year), data = sp512, statistic = "proportion", type = "ht", method = "theoretical", null = 0, alternative = "twosided", success = "atheist")
```
...
inference(y = response, x = as.factor(year), data = us512, statistic = "proportion", type = "ht", method = "theoretical", null = 0, alternative = "twosided", success = "atheist")
```
...
<li> 0 </li>
<li> 1 </li> 
<li><font color="red"> 1.95 </font></li> 
<li> 5 </li>
</ol>
```{r type1}
...
<li> 9604 people </li> 
<li><font color="red"> At least 9604 people </font></li>
</ol>
```{r sample-size}
