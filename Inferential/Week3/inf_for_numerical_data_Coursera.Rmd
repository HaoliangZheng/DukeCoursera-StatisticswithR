...
<li><font color="red"> The births </font></li>
</ol>
...
<li><font color="red"> Both distributions are extremely right skewed. </font></li>
...
<li><font color="red"> $H_0: \mu_{smoking} = \mu_{non-smoking}$; $H_A: \mu_{smoking} \ne \mu_{non-smoking}$ </font></li>
...
<li><font color="red"> We are 95% confident that babies born to nonsmoker mothers are on average 0.05 to 0.58 pounds heavier at birth than babies born to smoker mothers. </font></li>
</ol>
```{r habit-weight-ci}
...
<li>(6.9779 , 7.2241)</li>
<li><font color="red">(38.0952 , 38.5742)</font></li>
</ol>
```{r weeks-ci-99}
