...
# type your code for the Exercise here, and Run Document
sample_means50 %>%
  summarise(x_bar_bar = mean(x_bar), pop_med = median(x_bar), 
...
<ol>
<li><font color="red"> The variability of the sampling distribution with the smaller sample size (`sample_means50`) is smaller than the variability of the sampling distribution with the larger sample size (`sample_means150`). </font></li>
